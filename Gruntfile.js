  ...
  grunt.initConfig({
    ...
    replace: {
      loader: {
        ...
        files: [
          {expand: true, flatten: true, src: ['src/npr-pym-lazyload-loader.js'], dest: 'build/'}
        ]
      }
    },
    preprocess:  {
      ...
      pym : {
        src : 'build/npr-pym-lazyload-loader.js',
        dest : 'build/npr-pym-lazyload-loader.js'
      },
    },
    concat: {
      loader: {
        options: {
          banner: '/*! npr-pym-lazyload-loader.js - v<%= pkg.version %> - ' +
                  '<%= grunt.template.today("yyyy-mm-dd") %> */\n'
        },
        src: ['build/npr-pym-lazyload-loader.js'],
        dest: 'dist/npr-pym-lazyload-loader.v<%= pkg.version[0] %>.js'
      },
    },
    uglify: {
      loader: {
        ...
        files: {
          'dist/npr-pym-lazyload-loader.v<%= pkg.version[0] %>.min.js': ['dist/npr-pym-lazyload-loader.v<%= pkg.version[0] %>.js']
        }
      }
    },
    watch: {
